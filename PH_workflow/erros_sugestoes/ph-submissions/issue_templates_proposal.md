...
I suggest creating a set of issue templates in four languages, with different options (new proposals, peer review for original lessons and translations). The templates should be located in the `.github/ISSUE_TEMPLATE/` folder of the `programminghistorian/ph-submissions` repository. The templates should be in the following languages:
